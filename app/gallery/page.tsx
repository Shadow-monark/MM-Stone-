      ...
      <header className="sticky top-0 z-50 bg-[#faf9f5]/95 backdrop-blur-md border-b border-stone-300 py-2 shadow-sm">
        <div className="w-full max-w-[95%] xl:max-w-[96%] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          ...
          <Link href="/" className="hidden sm:flex items-center gap-2.5 shrink-0">
            ...
            <span className="text-xs sm:text-sm font-bold tracking-[0.16em] text-stone-900 uppercase">
              M.M STONE GALLERY
            </span>
          </Link>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#5c1818] hover:bg-[#7a1f1f] text-white font-bold text-xs uppercase tracking-[0.14em] px-3.5 py-1.5 rounded-full transition-all shadow-sm shrink-0"
          >
