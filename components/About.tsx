...
export default function About() {
  return (
    <section id="about" className="py-14 sm:py-18 bg-[#faf9f5] relative overflow-hidden text-stone-900 border-t border-stone-200">
      ...
      <div className="relative z-10 w-full max-w-[95%] xl:max-w-[96%] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-stretch mb-20">
          ...
          <motion.div 
            ...
            className="lg:col-span-6 flex flex-col justify-between relative bg-white border border-stone-300 rounded-sm p-4 sm:p-6 shadow-md"
          >
            {/* 4-Image Collage Grid */}
            <div className="grid grid-cols-2 gap-3 relative rounded-sm overflow-hidden flex-1">
              
              {/* Photo 1: Raw Quarry Mining Bed */}
              <div className="relative aspect-[4/3] rounded-sm overflow-hidden border border-stone-200 shadow-xs group bg-stone-100">
                <img
                ...
                <span className="absolute bottom-2 left-2 text-[9px] sm:text-[10px] uppercase font-bold text-amber-200 tracking-wider bg-stone-900/90 px-2 py-0.5 rounded-sm border border-stone-700">
            ...
            {/* License Stamp Banner */}
            <div className="mt-4 pt-3 border-t border-stone-200 flex items-center justify-between bg-stone-50 px-4 py-2.5 rounded-sm border border-stone-200">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#5c1818]" />
                <span className="text-[#5c1818] font-serif text-lg font-bold">ML 13/2022</span>
              </div>
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-6 bg-white p-6 sm:p-8 rounded-sm border border-stone-300 shadow-md">
            <div className="space-y-6">
              ...
              <AnimatedHeading
                ...
                italicWord="Reliefs"
                className="text-3xl sm:text-4xl lg:text-4xl font-normal text-stone-900 leading-[1.22]"
              />
            ...
            >
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-sm bg-stone-100 border border-stone-200 text-stone-900 shrink-0 shadow-2xs">
                  <ShieldCheck className="w-4 h-4 text-[#5c1818]" />
                </div>
                <div>
                  <h4 className="text-stone-900 text-xs font-bold mb-0.5">Direct Mines Ownership</h4>
                  <p className="text-stone-600 text-[11px] leading-snug font-light">Single-vein color consistency for large architectural contracts.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-stone-900 text-xs font-bold mb-0.5">Master Artisans & CNC</h4>
                  <p className="text-stone-600 text-[11px] leading-snug font-light">Deep-undercut carving and micro-calibrated slab tolerances.</p>
                </div>
              </div>
            </motion.div>
