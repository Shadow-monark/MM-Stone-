  ...
  return (
    <section className="py-28 sm:py-36 bg-stone-950 relative overflow-hidden text-white border-t border-stone-800">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden opacity-25">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-stone-950 via-stone-950/75 to-stone-950/80" />
        <div className="absolute inset-0 bg-gradient-to-r from-stone-950/90 via-stone-950/60 to-stone-950/90" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-amber-300 block mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((feature, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-stone-900/85 border border-stone-800 p-8 sm:p-9 rounded-sm hover:border-amber-500/50 transition-colors duration-300 flex flex-col justify-between group shadow-xl hover:shadow-2xl backdrop-blur-md"
            >
              <div>
